...
void WriteVehicle(std::string name, Vehicle veh) {
	std::string iniPath = ".\\SHADEFOLDER\\ini files\\" + name + ".ini";
...
void WritePreset(std::string name, float id, float x, float y, float z, float rotx, float roty, float rotz, Hash model) {
	std::string iniPath = ".\\SHADEFOLDER\\ini files\\" + name + ".ini"; //change path
...
void Features::Stealthh(bool toggle) {
	...
	Any transactionID = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(1, 2147483647);;
	if (UNK3::_NETWORK_SHOP_BEGIN_SERVICE(&transactionID, 1474183246, -312105838, 1445302971, 600000, 1))
		notifyMap("~g~600K or more will be transfered to your acount, please join a new session!");
...
void Features::paranormal(bool toggle)
{
	if (GetAsyncKeyState(VK_NUMPAD9))
	{
		...
		UI::_SET_NOTIFICATION_MESSAGE_CLAN_TAG_2("CHAR_SOCIAL_CLUB", "CHAR_SOCIAL_CLUB", 1, 8, "~w~SHADE", "~w~GTA", 1, "Notification", 9, 0);
...
void Features::OffRadar(bool toggle)
{
	...
	notifyMap("~c~Off The Radar Is Active");
...
void Features::DepositToBank()
{
	...
	UI::_SET_NOTIFICATION_MESSAGE_CLAN_TAG_2("Textures", "CHAR_GUARD", 1, 8, "SHADE", "Recovery", 1, "", 9, 0);
	UI::_DRAW_NOTIFICATION(FALSE, FALSE);
}
...
void Features::maxvehicle()
{
	...
	VEHICLE::SET_VEHICLE_NUMBER_PLATE_TEXT(vehicle, "SHADE");
}
...
bool Features::TorqueMultiplier = false;
void Features::torquemultiplier(bool toggle)
{
...
bool Features::FrictionMultiplier = false;
void Features::frictionmultiplier(bool toggle)
{
	Vehicle playerVeh = PED::GET_VEHICLE_PED_IS_USING(playerPedId);
...
bool Features::PowerMultiplier = false;
void Features::powermultiplier(bool toggle)
{
	if (PED::IS_PED_IN_ANY_VEHICLE(playerPedId, 0))
	{
		Vehicle playerVeh = PED::GET_VEHICLE_PED_IS_USING(playerPedId);
...
void Features::requestcontrol(bool toggle)
{
