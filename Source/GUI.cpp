...
void Menu::notifysimpulse(char* text) {
...
std::string Menu::Settings::menuend = "icon";
...
void Menu::Drawing::Title(const char* text, RGBAF rgbaf, VECTOR2 position, VECTOR2_2 size, bool center)
{
	...
	if (Menu::Settings::titleRectTexture == 0) {
		...
		Drawing::Spriter("TEXTURES", Features::current_header, Settings::menuX, 0.0800f, 0.24f, 0.090f, 0, Settings::titleRect.r, Settings::titleRect.g, Settings::titleRect.b, 255);
	}

	if (Menu::Settings::titleRectTexture == 1) {

		Drawing::Spriter("TEXTURES", "HEADER1", Settings::menuX, 0.0800f, 0.24f, 0.090f, 0, Menu::Settings::titleRect.r, Menu::Settings::titleRect.g, Menu::Settings::titleRect.b, Menu::Settings::titleRect.a);
	}

	if (Menu::Settings::titleRectTexture == 2) {

		Drawing::Spriter("TEXTURES", "HEADER2", Settings::menuX, 0.0800f, 0.24f, 0.090f, 0, Menu::Settings::titleRect.r, Menu::Settings::titleRect.g, Menu::Settings::titleRect.b, Menu::Settings::titleRect.a);
	}

	if (Menu::Settings::titleRectTexture == 3) {

		Drawing::Spriter("TEXTURES", "HEADER3", Settings::menuX, 0.0800f, 0.24f, 0.090f, 0, Menu::Settings::titleRect.r, Menu::Settings::titleRect.g, Menu::Settings::titleRect.b, Menu::Settings::titleRect.a);
	}

	if (Menu::Settings::titleRectTexture == 4) {

		Drawing::Spriter("TEXTURES", "HEADER4", Settings::menuX, 0.0800f, 0.24f, 0.090f, 0, Menu::Settings::titleRect.r, Menu::Settings::titleRect.g, Menu::Settings::titleRect.b, Menu::Settings::titleRect.a);
	}

	if (Menu::Settings::titleRectTexture == 5) {

		Drawing::Spriter("TEXTURES", "HEADER5", Settings::menuX, 0.0800f, 0.24f, 0.090f, 0, Menu::Settings::titleRect.r, Menu::Settings::titleRect.g, Menu::Settings::titleRect.b, Menu::Settings::titleRect.a);
	}

	if (Menu::Settings::titleRectTexture == 6) {

		Drawing::Spriter("TEXTURES", "HEADER6", Settings::menuX, 0.0800f, 0.24f, 0.090f, 0, Menu::Settings::titleRect.r, Menu::Settings::titleRect.g, Menu::Settings::titleRect.b, Menu::Settings::titleRect.a);
...
RGBAF Menu::Settings::optionTextt{ 255, 255, 255, 180, 4 };
...
RGBA Menu::Settings::arrows{ 255, 255, 255, 255 };
...
void scrollbar() {
	...
	if (Settings::menuLevel > 0) {
		if (optcnt > optcnt) {
			GRAPHICS::DRAW_RECT(Settings::menuX - 0.130, 0.437f, 0.012f, (curopt * 0.035f + 0.039f), 14, 14, 14, 196);
			GRAPHICS::DRAW_RECT(Settings::menuX - 0.130f, ((((curopt * (curopt * 0.035f)) / optcnt))) + 0.155f, 0.010f, 0.035f, 255, 0, 0, 235);
		}
	}
}
...
void Menu::Title(const char* title)
{
	...
	Drawing::Title("Shade", Settings::titleText, { Settings::menuX, 0.060f }, { 0.85f, 0.85f }, true);
...
bool Menu::Option(const char* option)
{
	...
	//	Drawing::Rect(Settings::optionRect, { Settings::scrollbarX, (Settings::optionCount) * 0.035f + 0.1415f }, { Settings::ScrollerWidth, 0.035f });//Scrollbar
	//	onThis ? Drawing::Rect(Settings::scroller, { Settings::scrollbarX, (Settings::optionCount) * 0.035f + 0.1415f }, { 0.007f, 0.035f }) : NULL; //Scrollbar
	...
	//	Drawing::Rect(Settings::optionRect, { Settings::scrollbarX, (Settings::optionCount - (Settings::currentOption - Settings::maxVisOptions)) * 0.035f + 0.1415f }, { Settings::ScrollerWidth, 0.035f });//Scrollabr
	//	onThis ? Drawing::Rect(Settings::scroller, { Settings::scrollbarX, (Settings::optionCount - (Settings::currentOption - Settings::maxVisOptions)) * 0.035f + 0.1415f }, { 0.007f, 0.035f }) : NULL;
...
/*ool Menu::MenuOptionn(const char* option, SubMenus newSub)
{
	Optionn(option);
...
bool Menu::MenuOption(const char* option, SubMenus newSub)
{
	...
	bool onThis = Settings::currentOption == Settings::optionCount ? true : false;
	if (Settings::currentOption <= Settings::maxVisOptions && Settings::optionCount <= Settings::maxVisOptions)
		Drawing::Text(">", onThis ? Settings::arrow2 : Settings::arrow, { Settings::menuX + 0.099f, Settings::optionCount * 0.035f + 0.128f }, { 0.25f, 0.25f }, true);
	else if (Settings::optionCount > Settings::currentOption - Settings::maxVisOptions && Settings::optionCount <= Settings::currentOption)
		Drawing::Text(">", onThis ? Settings::arrow2 : Settings::arrow, { Settings::menuX + 0.099f, (Settings::optionCount - (Settings::currentOption - 16)) * 0.035f + 0.12f }, { 0.25f, 0.25f }, true);
...
bool Menu::Int(const char* option, int& _int, int min, int max)
{
	...
	if (Settings::currentOption <= Settings::maxVisOptions && Settings::optionCount <= Settings::maxVisOptions)
		Drawing::Text(Tools::StringToChar("~w~(" + std::to_string(_int) + ") ~w~/" + std::to_string(max)), Menu::Settings::optionText, { Settings::menuX + 0.068f, Settings::optionCount * 0.035f + 0.130f }, { 0.28f, 0.28f }, true);
	else if (Settings::optionCount > Settings::currentOption - Settings::maxVisOptions && Settings::optionCount <= Settings::currentOption)
		Drawing::Text(Tools::StringToChar("~w~(" + std::to_string(_int) + ") ~w~/" + std::to_string(max)), Menu::Settings::optionText, { Settings::menuX + 0.070f, (Settings::optionCount - (Settings::currentOption - 16)) * 0.035f + 0.130f }, { 0.28f, 0.28f }, true);
...
bool Menu::Int(const char* option, int& _int, int min, int max, int step)
{
	...
	if (Settings::currentOption <= Settings::maxVisOptions && Settings::optionCount <= Settings::maxVisOptions)
		...
		Drawing::Text(Tools::StringToChar("~w~(" + std::to_string(_int) + ") ~w~/" + std::to_string(max)), Menu::Settings::optionText, { Settings::menuX + 0.068f, (Settings::optionCount - (Settings::currentOption - 16)) * 0.035f + 0.130f }, { 0.28f, 0.28f }, true);
...
/*void Menu::End(const char * title)
{
	...
	if (opcount >= 16) {
		...
		Drawing::Rect(Settings::scroller, { Settings::menuX, 17 * 0.035f + 0.1415f }, { 0.24f, 0.035f });
		Drawing::Rect(Settings::scroller, { Settings::menuX, 17 * 0.035f + 0.1235f }, { 0.24f, 0.002f });
		Drawing::Rect({ 0, 0, 0, 255 }, { Settings::menuX - 0.130f, Settings::menuY + 17 * 0.035f + -0.027f }, { 0.01f, 0.018f });
		Drawing::Text("4", { 255, 255, 255, 255, 3 }, { Settings::menuX - 0.135f, Settings::menuY + 17 * 0.035f + -0.047f }, 0.30f);
		Drawing::Spriter("TEXTURES", "icon", Settings::menuX, ((16 + 1) * 0.035f + 0.140f), 0.020f, 0.035f, 180, Settings::linego.r, Settings::linego.g, Settings::linego.b, Settings::linego.a);
	}
	else if (opcount > 0) {
		Drawing::Text(Tools::StringToChar(std::to_string(currop) + " // " + std::to_string(opcount)), Settings::count, { Settings::menuX + 0.078f, (Settings::optionCount + 1) * 0.035f + 0.125f }, { 0.35f, 0.35f }, true);
		Drawing::Rect(Settings::scroller, { Settings::menuX, (Settings::optionCount + 1) * 0.035f + 0.1415f }, { 0.24f, 0.035f });

		Drawing::Rect({ 0, 0, 0, 255 }, { Settings::menuX - 0.130f, Settings::menuY + 17 * 0.035f + -0.027f }, { 0.01f, 0.018f });
		Drawing::Text("4", { 255, 255, 255, 255, 3 }, { Settings::menuX - 0.135f, Settings::menuY + 17 * 0.035f + -0.047f }, 0.30f);
		Drawing::Rect(Settings::scroller, { Settings::menuX, (Settings::optionCount + 1) * 0.035f + 0.1235f }, { 0.24f, 0.002f });
		Drawing::Spriter("TEXTURES", "icon", Settings::menuX, ((Settings::optionCount + 1) * 0.035f + 0.140f), 0.020f, 0.035f, 180, Settings::linego.r, Settings::linego.g, Settings::linego.b, Settings::linego.a);
...
/*void Menu::End(const char * title)
{
	...
	if (opcount >= 16) {
		...
		Drawing::Text(Tools::StringToChar(std::to_string(currop) + "/" + std::to_string(opcount)), Settings::count, { Settings::menuX + 0.087f + (Settings::scrollbarWidthIndex - 0.12f), Settings::menuY + 17 * 0.035f - 0.467f }, { 0.3f, 0.3f }, true);		Drawing::Rect(Settings::Endrectlol, { Settings::menuX, 17 * 0.035f + 0.1415f }, { 0.24f, 0.035f });
		Drawing::Rect(Settings::scroller, { Settings::menuX, 17 * 0.035f + 0.1235f }, { 0.24f, 0.002f });
		//rawing::Rect({ 0, 0, 0, 255 }, { Settings::menuX - 0.130f, Settings::menuY + 17 * 0.035f + -0.029f }, { 0.01f, 0.018f });
		Drawing::Spriter("TEXTURES", "end", Settings::menuX, ((16 + 1) * 0.035f + 0.140f), 0.020f, 0.035f, 180, Settings::linego.r, Settings::linego.g, Settings::linego.b, Settings::linego.a);
	}
	else if (opcount > 0) {
		Drawing::Rect(Settings::Endrectlol, { Settings::menuX, (Settings::optionCount + 1) * 0.035f + 0.1415f }, { 0.24f, 0.035f });
		...
		Drawing::Rect(Settings::scroller, { Settings::menuX, (Settings::optionCount + 1) * 0.035f + 0.1235f }, { 0.24f, 0.002f });
		Drawing::Spriter("TEXTURES", "end", Settings::menuX, ((Settings::optionCount + 1) * 0.035f + 0.140f), 0.020f, 0.035f, 180, Settings::linego.r, Settings::linego.g, Settings::linego.b, Settings::linego.a);
		...
		if (GetTickCount() - Settings::keyPressPreviousTick2 > Settings::keyPressDelay2) {
			if (GetTickCount() - Settings::keyPressPreviousTick3 > Settings::keyPressDelay3) {
				if (IsKeyPressed(VK_F4) || CONTROLS::IS_DISABLED_CONTROL_PRESSED(0, ControlScriptRB) && CONTROLS::IS_DISABLED_CONTROL_PRESSED(0, ControlPhoneRight)) {
					...
					if (firstopen) {
						//IconNotification(Menu::Tools::StringToChar("~w~Welcome " + (std::string)PLAYER::GET_PLAYER_NAME(0)), "~w~Diamond Menu v4.0.1", text);
